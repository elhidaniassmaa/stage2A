...
export default function StatistiquesTendances({ user }) {
  ...
  const enregistrerDansHistorique = async () => {
    const params = new URLSearchParams({
      nom: "Statistiques & Tendances",
      type_rapport: "tendances",
  ...
  return (
    <div style={styles.page}>
      ...
      {messageAction && <div style={{ backgroundColor: '#ECFDF5', color: '#047857', border: '1px solid #A7F3D0', padding: '10px 16px', borderRadius: '8px', marginBottom: '16px', fontSize: '0.85rem', fontWeight: 600 }}>{messageAction}</div>}
