...
def init_db():
    ...
    if cursor.fetchone()[0] == 0:
        ...
        # Quelques mots par défaut structurés si le fichier n'est pas lu
        default_mots = [
            ("salaud", "Français", "Vulgarité A"),
            ("bâtard", "Français", "Vulgarité A"),
            ("merde", "Français", "Terme non-conforme C"),
            ("imbécile", "Français", "Injure spécifique B"),
            ("débile", "Français", "Injure spécifique B"),
            ("escroc", "Français", "Calomnie"),
            ("voleur", "Français", "Calomnie"),
            ("corrompu", "Français", "Corruption"),
            ("حمار", "Arabe standard", "Obscénité"),
            ("كلب", "Arabe standard", "Obscénité"),
            ("غبي", "Arabe standard", "Injure spécifique B"),
            ("خسيس", "Arabe standard", "Vulgarité A"),
            ("hmar", "Darija", "Obscénité"),
            ("kalb", "Darija", "Obscénité"),
            ("mkelleg", "Darija", "Injure spécifique B"),
            ("chouha", "Darija", "Terme non-conforme C"),
            ("mseti", "Darija", "Injure spécifique B"),
            ("zbel", "Darija", "Obscénité")
        ]
            ...
            try:
                ...
                with open(words_file, "r", encoding="utf-8") as f:
                    for line in f:
                        ...
                        # Déduire une catégorie factice pour le design
                        cat = "Vulgarité A"
                        if line in ["escroc", "voleur", "menteur"]:
                            cat = "Calomnie"
                        elif line in ["corrompu", "faised", "فاسد"]:
                            cat = "Corruption"
                        elif line in ["hacker", "injection", "xss", "payload", "exploit", "phishing"]:
                            cat = "Exploit"
                        elif len(line) > 6:
                            cat = "Terme non-conforme C"
