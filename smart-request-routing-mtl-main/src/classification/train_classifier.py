...
def main():
    ...
    print(f"Téléchargement du tokenizer et du modèle {model_name}...")
    ...
    training_args = TrainingArguments(
        ...
        num_train_epochs=15,                  # 3 époques pour un entraînement rapide et suffisant
        per_device_train_batch_size=16,      # Batch size adapté
