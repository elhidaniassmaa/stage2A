      ...
      <div style={styles.entete}>
        ...
        <div style={styles.actionsBar}>
          <label style={styles.checkboxLabel}>
            <input
              type="checkbox"
              checked={sauvegarderHistorique}
              onChange={(e) => setSauvegarderHistorique(e.target.checked)}
            />
            Garder dans l'historique des rapports
          </label>
          <button style={styles.btnPrimary} onClick={handleTelecharger} disabled={exportEnCours}>
