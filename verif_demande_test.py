"""
Vérifie si la demande de test (id=65) existe bien dans la base canonique,
et si son statut/alerte sont cohérents pour déclencher un email.
À lancer depuis la racine du projet : python verif_demande_test.py
"""
import sqlite3
import os
